...
namespace TechDistribution.GUI
{
    public partial class AuthorForm : Form
    {
        ...
        AuthorController auCtrl = new AuthorController();
        public AuthorForm()
        {
            InitializeComponent();
        }
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            auCtrl.UpdateAuthor(updateAuthor);
        ...
        {
            AuthorController rep = new AuthorController();


            dataGridView2.DataSource = null;
            dataGridView2.Refresh();

            dataGridView2.DataSource = rep.GetAuthors();
        }
        ...
        private void SearchByName()
        {
            ...
            var search = auCtrl.GetAuthorByName(text);
        ...
        private void SearchByEmail()
        {
            ...
            var search = auCtrl.GetAuthorByEmail(text);
